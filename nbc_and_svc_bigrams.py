# -*- coding: utf-8 -*-
"""NBC AND SVC  BIGRAMS.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OliStFo4C1D5Xn-Hvq1AJ7FY_roHpVDx
"""
...
df.to_csv('Bigrams_cleaned tokens for Machine learning.csv')
...
tfidf = TfidfVectorizer(min_df=.0015, ngram_range=(1,2)) # min_df=.0015 means that each ngram (unigram, bigram, & trigram) must be present in at least 16 documents for it to be considered as a token (10572* 0.0015=15.858). This is a clever way of feature engineering
tfidf.fit(data) # learn vocabulary of entire data
data_tfidf = tfidf.transform(data) # creating tfidf values
tfidf.get_feature_names()
#pd.DataFrame.from_dict(data=dict([word, i] for i, word in enumerate(tfidf.get_feature_names())), orient='index').to_csv('features_bigram.csv', header=False)
